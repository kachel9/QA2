...
public class TestDPK {

    final String setTo="31";
    ...
    public void checkGoogle() throws InterruptedException {
        ...
        WebElement dkpp = driver.findElement(By.xpath("//*[contains(@class,'buttons')]//*[text()='ДКПП']"));
        dkpp.click();
        ...
        String text3 = driver.findElement(By.className("result-all")).getText();
        System.out.println(text3);

        Assert.assertEquals(text3, "Знайдено: 8 432");
        driver.close();
}}
